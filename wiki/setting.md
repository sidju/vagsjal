...
bekanta för vampyrerna i världen är blodet, vilket genomsyrar hela deras
existens.
...
VägSjäl är en värld av kaos där vampyrsamhället saknar en naturlig källa till
stabilitet och ordning. De flesta äldre vampyrerna håller sig undan för sin
säkerhet; att skapa ordning är att riskera sin död. Ingen stor organisation har
envälde och kan påtvinga ordning, kovenanterna har fullt upp med varandra och
sitt spel. Det blir upp till var och en att skapa en ordning, och därmed upp
till var och en att välja vilken ordning de ska bidra till att skapa.
