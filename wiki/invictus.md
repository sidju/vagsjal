...
bibehålla makt. De ser sig som de rättmätiga härskarna av alla besläktade och
använder sig av pengar, mänskligt inflytande och politisk auktoritet för att nå
sina mål.

## Historia

Invictus kan rimligen hävdas vara den äldsta nu existerande kovenanten. Deras
...
monstret de blivit. Men är det mindre monstruöst att bli en parasit på det
mänskliga samhället?

## Organisation

Invictus leds av de äldsta och de högst respekterade besläktade. Rang och titlar
är A och O för att uppnå politisk makt i kovenanten. Av den anledningen finns
det en otalig mängd utmärkelser som kan uppnås. Individer med en titel betraktas
i regel som högre än någon otitulerad. Även de flesta ansvarsområden kan belönas
med titulering. Samordna dig med andra invictusspelare för att komma överens om
vilka titlar som kommer finnas i spel och hur de spelas på.

### Adelstitlar

- **Borgare**: Förlänas till en besläktad för hedersam tjänstgöring för
  kovenanten.
- **Baron**: Förlänas till en besläktad som vid flera tillfällen utmärker sig
  som framstående.
- **Greve**: Förlänas till en besläktad som har blivit tilldelad en egen domän
  inom Invictus territorier.
- **Markis**: Förlänas till en besläktad som har fått en permanent plats vid en
  stads inre råd.- **Furste**: Förlänas till en besläktad som erövrat en stad
  och etablerat en stark maktbas för Invictus.

### Hedersbetygelser

Dessa tilldelas alla invictus utefter ålder och mognad.

- **Lärling**: Nyinvigt besläktad, i sin sires eller annan mentors läro.
- **Gesäll**: En fristående invictus, som lämnat sin sire.
- **Mäster**: Titel som tilldelas vid ansenlig ålder. Exakt ålder varierar
  mellan domäner, men minst 50 år är praxis.

### Ansvarstitlar

Det finns otaliga ansvarstitlar för allehanda uppgifter inom kovenanten, även
för de uppgifter som inte varit relevanta på 1000 år. Spelare är välkomna att
skapa dem efterhand de blir relevanta så fylls de i här.

### Sammanfattning

Invictus eftersträvar en rak och tydlig maktfördelning, där prestation belönas
med mer makt. Men då kovenanten existerat så pass länge finns nu fler titlar än
de flesta besläktade kan hålla koll på. Då är det tur att det finns en titel
även för detta, om än otursamt att de omöjligen kan ha koll på titlar som delas
ut utanför domänen utan ytterligare efterforskningar.
...
- **Vite**: En alternativ utveckling av blodskontrakt som straffar den part som
