...
lära till alla andra besläktade. De helgade, som dess medlemmar kallar sig
själva, ser sin existens som ett heligt syfte: de har blivit förbannade av Gud
och utvalda att i hans namn sätta skräck i mänskligheten så att de skall en dag
vända sig till Herren. Där löftet om paradiset är mänsklighetens morot är Lancea
...
Enligt Longinus Testamente, kovenantens heliga text, grundades kovenanten av den
romerska centurion Longinus, soldaten som sägs ha genomborrat Kristus med sin
lans när han var på korset, därav kovenantens namn ”Lansens fristad”. Oavsett
sanningshalten i de berättelser och myter kovenanten berättar är det ett faktum
att Lancea et Sanctum är den äldsta aktiva kovenanten, och många av de normer
och traditioner som besläktade följer idag etablerades av dem.
...
medlemmar inte avvisa och förakta sin existens, för de är en skapelse av Gud och
därmed en del av hans gudomliga plan. Enligt testamentet är detta att agera som
Guds heliga monster.
...
respekterade och mäktigaste inom domänen. Alla präster svär en ed till
kovenanten och i samband med det en religiös ed vars exakta innehåll varierar
från domän till domän. De vanligaste kräver att prästen endast dricker från
vissa typer av personer, under vissa nätter eller under vissa specifika
klockslag, och/eller spenderar tid på Elysium för att vara tillgänglig för de
som vill bikta sig.

Prästerskap titlarna kallas för huvudämbeten, och de är följande:

- **Präst**: Det vanligaste ämbetet. En präst är den mest flexibla rollen inom
  prästerskapet. De är spirituella vägledare, diplomater, administratörer,
  arkivister och ibland även heliga krigare.
- **Biskop**: Biskopen har ansvar för den lokala grenen av kovenanten i en domän
  och brukar vara prästerskapets lokala ledare. Dess roll kan jämföras med det
  av en primogen. Oftast finns det bara en biskop i varje domän, men i vissa
  väldigt stora kan det finnas upp till fem, alla då under befälet av en
  ärkebiskop.
- **Ärkebiskop**: Oftast det högsta ämbetet i en domän. De har ansvar för
  domänen som helhet, och kovenanten använder denna titel istället för prins.
  Alla domäner har inte en ärkebiskop då det inte alltid finns ett behov.
...
man är ordinerad och en del av prästerskapet. De är följande:

- **Ostiarius** (icke-ordinerad): En defensiv soldatroll som generellt sett
  endast finns i domäner styrda av Lancea et Sanctum. Dess uppgift är att bevaka
  resvägar in och ut från domänen och stoppa eventuella fiender till domänen
  från att komma in. De lyder Sheriffen eller en utsedd Biskop.
- **Församlings Arkivarie** (icke-ordinerad): Kovenantens informationsinsamlare
  och beskyddare av dess heliga, hemliga och allmänna nedskrivna information.
  Denna information är traditionellt sätt nedskriven på pergament.
- **Korsriddare** (präst): En fanatisk soldatroll vars syfte är att användas som
  ett levande vapen av resten av prästerskapet.
- **Inkvisitor** (präst): Kovenantens moralpolis vars syfte är att finna kättare
  inom de egna leden.
- **Legate** (Biskop): En icke-formell position som agerar som diplomat till
  andra domäner.
- **Helgon** (Elder): Den högsta och mest ärade titeln inom Lancea et Sanctum.
  Titeln är inofficiell, men dess status är utan dess like. De som bär denna
  titel är de mest fromma och lärda bland de helgade och anses vara
  personifieringen av Longinus lära.
