...
Du har en startmängd XP baserat på din karaktärs ålder, denna kan ses på
[Karaktärsblad](/character/) när karaktären är godkänd.

## Att använda XP

Under in-appning och efter XP-utdelning kan du använda karaktärs XP för att köpa
nya förmågor. Priserna för dem kan ses i följande tabell:

| Färdighet                                           | XP-kostnad |
| --------------------------------------------------- | ---------- |
| [Fysisk förmåga](physical-ability.md)               | 4          |
| [Mental förmåga](mental-ability.md)                 | 4          |
...
| Andra [krafter](blood-powers.md) | XP-kostnad |
| -------------------------------- | ---------- |
| Nivå 1                           | 12         |
| Nivå 2                           | 18         |
| Nivå 3                           | 30         |
...
### Undvik min-maxning, särskilt för äldre karaktärer

Det är frestande att lägga allt på en aspekt av spelet, men det blir ofta
