...
- Den [klan](/wiki/clan/) som du ska spela (de andra kan läsas, men inget krav).
...
- Traditionerna är inte beslutade lagar utan tre läxor så väl lärda av dåtida
  vampyrer att de är inneboende i blodet. Att bryta dem är fullt möjligt och
  inte helt ovanligt, men alla vet att det finns både direkta och sociala
  konsekvenser.
- Äldre vampyrer än 120 år är sällsynta i världen. De flesta har dragit sig
  undan eller ligger rakt av i torpor för att sänka sin BP till en hanterbar
  nivå, om de inte redan har dött. Enda undantaget är Ordo Dracul som har en
  betydligt större andel vakna äldre, vilket bidrar till och kompenserar för
  deras passivitet i politiken Kovenanterna emellan.
- Vi uppmuntrar till att bidra till att skapa världen genom era backstories.
  Står inget om en domän på hemsidan är ni mycket välkomna att skapa den och
  signifikanta karaktärer i den så hanterar vi det under in-appningen.
